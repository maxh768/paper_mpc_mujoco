...
def mjmod_init(x0):
    ...
    path2xml = '/home/max/workspace/paper_mpc_mujoco/code/LQR_doublepend/DoublePendulum.xml'
...
def linearize(model, data, lin_state, lin_control):
    ...
    x0[3] = lin_state[3]
    u0 = lin_control
    cmod, cdat = clone_mj(model, data, x0, u0)
